...
<div class="containerSkill">
      ...
      <img src="images/certificaat-1.PNG">
      </div>
    
      <div id="2" class="itemSkill">
      <img src="images/certificaat-2.PNG">
      </div>
    ...
    <div class="menu">
      <a class="btn btn-primary" href="#navbarSupportedContent" ><i class="fas fa-angle-double-up" style="font-size: 3rem"></i></a>
      <br>
      <br>
      <a class="btn btn-primary" href="#1" >#1</a>
      <br>
      <br>
      <a class="btn btn-primary" href="#2">#2</a>
      <br>
      <br>
      <a class="btn btn-primary" href="#3">#3</a>
    </div>
